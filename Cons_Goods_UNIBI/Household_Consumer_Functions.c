...
int Household_rank_and_buy_goods_1()
{
	...
	for(i=0; i<CURRENT_PRICE_QUALITY_LIST.size;i++)
    	...
    	if( quality_price_info_1_message->available==1)
    		...
    		if(quality_price_info_1_message->firm_region_id==REGION_ID){
    			add_mall_quality_price_info(&mall_quality_price_info_list,  quality_price_info_1_message->mall_id, quality_price_info_1_message->firm_id,               quality_price_info_1_message->mall_region_id,                   2,                  quality_price_info_1_message->price,
        quality_price_info_1_message->available);

    		}else{
    			add_mall_quality_price_info(&mall_quality_price_info_list,  quality_price_info_1_message->mall_id, quality_price_info_1_message->firm_id,               quality_price_info_1_message->mall_region_id,                   1,                  quality_price_info_1_message->price,
    			        quality_price_info_1_message->available);
    		}
        ...
        for(i = 0; i < mall_quality_price_info_list.size;i++) 
        {
            ...
            .available) * exp(GAMMA_QUALITY*log(mall_quality_price_info_list.array[i].quality) -GAMMA_CONST*log(mall_quality_price_info_list.array[i].price));
        ...
        for(i = 0; i < mall_quality_price_info_list.size;i++) 
        {
            logit = (mall_quality_price_info_list.array[i].available) *
			 exp(GAMMA_QUALITY*log(mall_quality_price_info_list.array[i].quality) -GAMMA_CONST*log(mall_quality_price_info_list.array[i].price)) /
...
int Household_rank_and_buy_goods_2()    
{
        ...
        if( quality_price_info_2_message->available==1)
        {
        	...
        	if(quality_price_info_2_message->firm_region_id==REGION_ID)
